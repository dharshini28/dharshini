...
public class Level1 extends Activity{
    ...
    @Override    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String n= prefs.getString("c","Beautiful morning");
        ...
        if(n.equals("Beautiful morning")){mp1.start();}
        if(n.equals("Like the devil")){mp2.start();}
        if(n.equals("Loneliness")){mp3.start();}
        if(n.equals("Cuckoo")){mp4.start();}
        if(n.equals("Jump start")){mp5.start();}
        if(n.equals("Wake up")){mp6.start();}
            ...
            public void onClick(View v) {
                ...
                try {
                    if (currentQ.getANSWER().equals(answer.getText())) {
                        if(n.equals("Beautiful morning")){mp1.stop();}
                        if(n.equals("Like the devil")){mp2.stop();}
                        if(n.equals("Loneliness")){mp3.stop();}
                        if(n.equals("Cuckoo")){mp4.stop();}
                        if(n.equals("Jump start")){mp5.stop();}
                        if(n.equals("Wake up")){mp6.stop();}
                        return;
                    }
